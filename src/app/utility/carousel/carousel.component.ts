...
@Component({
    ...
    <div (mouseenter)="pause()" (mouseleave)="play()" class="carousel slide">
      ...
      <div class="carousel-inner"><ng-content></ng-content></div>
                  <a class="left carousel-control" style="left:180px" (click)="prev()" [hidden]="!slides.length">
                  <span class="glyphicon glyphicon-chevron-left"></span>
                  </a>
                  <a class="right carousel-control" style="right:180px" (click)="next()" [hidden]="!slides.length">
